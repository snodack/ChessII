...
tm = time.time()
def find_chess_moves(player_color, position):
    all_exists_moves = []
...
def find_king_moves(player_color, position, rank, file):
    all_king_moves = []
    kings_default_mos = [[1,0], [1,0],]
...
start_position = [["wR","wN","wB","wQ","wK","wB","wN","wR"],
                    ["wP","wP","wP","wP","wP","wP","wP","wP"],
                    [None,None,None,None,None,None,None,None],
                    [None,None,None,None,"wN",None,None,None],
                    [None,None,None,None,None,None,None,None],
                    [None,None,None,None,None,None,None,None],
